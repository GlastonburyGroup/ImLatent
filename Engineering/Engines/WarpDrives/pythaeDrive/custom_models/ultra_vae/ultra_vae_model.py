...
from .ultra_vae_config import UltraVAEConfig
from .ultra_vae_utils import UltraPredictor, anti_confounder_loss

from ......utilities import PlasmaConduit

class UltraVAE(BaseAE):
    ...
    def __init__(
        ...
        if self.learn_phenotypes:
            self.phenotype_learner = UltraPredictor(latent_dim=model_config.latent_dim, n_layers=model_config.n_phenotype_layers, n_predictions=model_config.n_phenotypes, p_do=model_config.p_do)
        ...
        if self.anti_confounders_strategy == 1:
            ...
            self.anti_counfounder_learner = UltraPredictor(latent_dim=model_config.latent_dim, n_layers=model_config.n_anti_confounder_layers, n_predictions=model_config.n_confounders, p_do=model_config.p_do)
